...
<main>
    <div class="container">
        <div class="content">
            <h1 class="title">Warfare By the Numbers: Visualizing Military Might</h1>
            <h3 class="subtitle">How does the visualization of military equipment usage during war periods shed light on the scale of the Russian-Ukrainian War?</h3>
